  ...
  return (
    <>
      <Dropdown align="start">
        <Dropdown.Toggle size="sm" id="channel-menu-dropdown" className="rounded-0" variant="outline-primary">
          <span className="visually-hidden">{t('chat.chatHeader.manageChannel')}</span>
        </Dropdown.Toggle>
